pub(crate) use aether_ai_formats::api::{
    ...
    apply_codex_openai_responses_special_headers, apply_grok_oauth_responses_reasoning_default,
    ...
    codex_hosted_image_generation_tool_allowed, convert_claude_chat_response_to_openai_chat,
    ...
    maybe_extract_openai_image_sync_failure_body, model_directive_base_model,
