...
CREATE TABLE IF NOT EXISTS niffler_route_attempts (
    ...
    KEY idx_niffler_route_attempts_created_at (`created_at_unix_ms`)
);
...
CREATE TABLE IF NOT EXISTS niffler_billing_reservation_dry_runs (
    ...
    KEY idx_niffler_billing_reservation_dry_runs_status_time (`status`, `created_at_unix_ms`),
    KEY idx_niffler_billing_reservation_dry_runs_user_time (`user_id`, `created_at_unix_ms`),
    KEY idx_niffler_billing_reservation_dry_runs_key_time (`api_key_id`, `created_at_unix_ms`)
);
