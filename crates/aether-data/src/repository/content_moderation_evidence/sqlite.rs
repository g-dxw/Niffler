...
#[derive(Debug, Clone)]
pub struct SqliteContentModerationEvidenceRepository {
    pool: SqlitePool,
}

impl SqliteContentModerationEvidenceRepository {
...
#[async_trait]
impl ContentModerationEvidenceReadRepository for SqliteContentModerationEvidenceRepository {
    async fn find_by_id(
        &self,
        evidence_id: &str,
...
#[async_trait]
impl ContentModerationEvidenceWriteRepository for SqliteContentModerationEvidenceRepository {
    async fn insert(
        &self,
...
fn map_row(row: &SqliteRow) -> Result<StoredContentModerationEvidence, DataLayerError> {
